...
**Note:** Version bump only for package @lfurzewaddock/react-financial-charts-core

## [2.0.2](https://github.com/reactivemarkets/react-financial-charts/compare/v2.0.1...v2.0.2) (2026-01-13)

### Bug Fixes

- zoom flicker for mouse wheel & y axis drag & add some types ([c9beb3b](https://github.com/reactivemarkets/react-financial-charts/commit/c9beb3ba1229159f5eeb428ac333bcc5a41913a7))
